                ...
                >
                    <template #body>
                        <div style="padding: 1rem;">
                            <p>CoManD' is an acronym for <strong>Co</strong>ntent <strong>MAN</strong>agement and <strong>D</strong>istribution."</p>
                        </div>
                    </template>
                </CmdBox>
                <h2>HTML/CSS</h2>
...
variables can be uses in native CSS for a ong time already. Additionally we want the Component Library to use the values defined for the CSS-variables of the Frontend Framework
 - no need to define everything again in SCSS-variables."
                ...
                <CmdBox
                    :cmdHeadline="{
                                headlineText: 'Will the SCSS be removed if nesting and media query-variables will be implemented in native CSS?',
                                headlineLevel: 3
                            }"
                    :collapsible="true"
