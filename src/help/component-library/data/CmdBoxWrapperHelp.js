export default [`<CmdBoxWrapper :useFlexbox="true">
    <CmdBox 
      v-for="index in 14" 
      :key="index" 
      textBody="Content" 
      :cmd-headline="{
        headlineText: 'Headline ' + index, headlineLevel: 3
      }" 
    />
</CmdBoxWrapper>`,
...
`<CmdBoxWrapper :boxesPerRow="[5, 2]">
    <CmdBox 
        v-for="index in 7" 
        :key="index" 
        textBody="Content" 
        :cmd-headline="{headlineText: 'Headline ' + index, headlineLevel: 3}" 
    />
</CmdBoxWrapper>`,
`<CmdBoxWrapper :boxesPerRow="[5]">
    <CmdBox 
      v-for="index in boxProduct.length" 
      :key="index" 
      boxType="product" 
      :product="boxProduct[index - 1]" 
      :cmdHeadline="{headlineLevel: 5}"
    />
</CmdBoxWrapper>`,
`<CmdBoxWrapper :boxesPerRow="[5]">
    <CmdBox 
        v-for="index in boxUser.length" 
        :key="index" 
        boxType="user" 
        :user="boxUser[index - 1]" 
        :cmdHeadline="{headlineLevel: 5}" 
    />
</CmdBoxWrapper>`
]